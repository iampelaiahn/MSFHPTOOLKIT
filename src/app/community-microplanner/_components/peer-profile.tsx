    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Search for and view peer profiles and risk history.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="border rounded-lg p-6 flex flex-col items-center justify-center text-center mt-6 h-64 bg-background/50">
                    ...
                    <p className="text-muted-foreground">Search for a peer to view their profile.</p>
                </div>
            </CardContent>
        </Card>
    );
